...
class Sales extends React.Component{
    ...
    calculateTotal = () => {
        ...
        let discount = document.getElementsById("discount").value;
    ...
    addToCart = ()=> {
        ...
        let isPercentage = discount.indexOf("%") > -1;
        errors += product.name === " " ? "El producto no puede estar vacio\n" : "";
        errors += qty === "" ? "La cantidad no puede estar vacia\n" : "";
        errors += isPercentage && parseInt(discount.replace("%", "")) > product.MDPercentaje ? "No puede descontar mas del $"+product.MDPercentaje+".\n": "";
